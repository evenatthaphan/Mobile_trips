...
import 'package:flutter_application_1/models/response/trips_get.dart';
...
class _ShowtripPageState extends State<ShowtripPage> {
                      ...
                      FutureBuilder(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return Column(
                              ...
                              //                   width: 150,
                              //                   height: 150,
                              //                   child: Image.asset('assets/images/Shi.jpg')),
                              //             ),
                              //             Column(
                              //               crossAxisAlignment: CrossAxisAlignment.start,
                              //               children: [
                              ...
                              //                   width: 150,
                              //                   height: 150,
                              //                   child: Image.asset('assets/images/Plu.jpg')),
                              //             ),
                              //             Column(
                              //               crossAxisAlignment: CrossAxisAlignment.start,
                              //               children: [
                              ...
                              //                   width: 150,
                              //                   height: 150,
                              //                   child: Image.asset('assets/images/Ta.jpg')),
                              //             ),
                              //             Column(
                              //               crossAxisAlignment: CrossAxisAlignment.start,
                              //               children: [
  ...
  Future<void> loadDataAsync() async {
    ...
    trips = tripsgetResponeFromJson(data.body);
  }

  void getTrips(String? zone) {
    http.get(Uri.parse("$url/trips")).then((value) {
      log(value.body);
      trips = tripsgetResponeFromJson(value.body);
      List<TripsgetRespone> filteredTrips = [];
      if (zone != null) {
